...
def cmd_update(args):
    ...
    base_path = Path(args.path or "~/Data/content/images").expanduser()
...
def main():
    ...
    rebuild_parser.add_argument('--path', default='~/Data/content/images',
                                help='Base archive path')

    # Search command
    search_parser = subparsers.add_parser('search', help='Search prompts by keyword')
    search_parser.add_argument('query', help='Search query')
    search_parser.add_argument('--path', default='~/Data/content/images',
                               help='Base archive path')
    ...
    update_parser.add_argument('--path', default='~/Data/content/images',
                               help='Base archive path')

    # List command
    list_parser = subparsers.add_parser('list', help='List recent images')
    list_parser.add_argument('--path', default='~/Data/content/images',
                             help='Base archive path')
    ...
    export_parser.add_argument('--path', default='~/Data/content/images',
                               help='Base archive path')
